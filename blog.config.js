...
const BLOG = {
  ...
  CONTACT_Wechat: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'violet22822', // 你的微信个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_LITTLEREDBOOK: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '阿璇', // 你的telegram 地址 例如 https://t.me/tangly_1024

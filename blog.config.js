...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，I am Violet. Nice to meet you🎉!',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Violet Wen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'I am from the SWUFE-UD Institute of Data Science at SWUFE, welcome to my channel!', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-eight-nu-47.vercel.app/zh', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'wyx1004326550@163.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_SMALLREDBOOK || 'https://www.xiaohongshu.com/user/profile/60ee65be00000000010044a6?xhsshare=CopyLink&appuid=60ee65be00000000010044a6&apptime=1716175671', // 你的微博个人主页
